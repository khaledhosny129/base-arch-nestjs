...
import { Competency, CompetencyDoc } from './entities/competency.entity';

@Injectable()
export class CompetencyService extends BaseService<CompetencyDoc> {
  constructor(
    @InjectModel(Competency.name)
    private readonly m: Model<CompetencyDoc>,
  ) {
    super(m);
  }
